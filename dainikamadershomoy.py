...
for index in range( 15299,20000 ):
        ...
        if(page_links_length == 0):
            ...
            for link in all_links:
                ...
                try:
                    ...
                    date = date_tokens[author_length + 1] + " " + date_tokens[author_length+2] + " " + date_tokens[author_length+3]
                    date = date.strip()
                except:
                    date = ""
                ...
                try:
                    ...
                    article_content = article_content.replace( "© সর্বস্বত্ব স্বত্বাধিকার সংরক্ষিত ২০০০-২০১৯  Privacy Policy","")

...
ignore_list = ["keyword","micr-code","swift-code","pin-code","tech","internet","blogging","seo","make-money-online","cryptocurrency","share-market","wiki","privacy-policy","keyword","about","contact"]
    ...
    for j in range(8):
        ...
        if (page_links_length == 0):
            ...
            for link in all_links:
                ...
                try:
                    article_content = article_soup.find("div", {"class":"td-post-content tagdiv-type"}).get_text().strip()

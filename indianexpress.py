        ...
        if(page_links_length == 0):
            ...
            for link in all_links:
                ...
                try:
                    ...
                    article_content = article_content.replace("Get all the Latest Bengali News and West Bengal News at Indian Express Bangla. You can also catch all the General  News in Bangla by following us on Twitter and Facebook","")
                except:
                    article_content += ""
